				...
				<div className="container">
					...
					<div className="row gap-bottom-40">
						<div className="col-xs-12 col-sm-12 col-md-6 col-lg-2">
							...
							{/* Logo */}
							<div className="onovo-f-logo gap-bottom-40" style={{"maxWidth": "140px"}}>
								<Link href="/">
								...
								<ul className="onovo-footer-menu">
									<li>
										<Link href="/services/service-1">
											<span className="onovo-lnk">Cyber Security</span>
										</Link>
									</li>
									<li>
										<Link href="/services/service-2">
											<span className="onovo-lnk">AI/ML</span>
										</Link>
									</li>
									<li>
						...
						<div className="col-xs-12 col-sm-12 col-md-6 col-lg-2">
							...
							1309 Coffeen Avenue STE 13600 Sheridan <br/>Wyoming 82801
								<p>
									...
									<br />
									<a className="onovo-lnk" href="mailto:hello@dhsol.net" target="blank">hello@dhsol.net</a>
								</p>
							</div>
